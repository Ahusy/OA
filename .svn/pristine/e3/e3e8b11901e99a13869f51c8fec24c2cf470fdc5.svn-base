...
public class ApprovalBillBusinessActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    private BillBusinessDetail bpcDetail;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_cancel:
                ...
                break;
            case R.id.tv_edit:
                BusinessActivity.startAct(this, bpcDetail, REQUEST_ACT_ONE);
                finish();
                break;
        }
    }
    ...
    protected void parseData(int requestCode, String data) {
        ...
        switch (requestCode) {
            case REQUEST_NET_ONE:
                bpcDetail = Parsers.getBillBusiness(data);
    ...
    private void updataUI(BillBusinessDetail bb, ArrayList<ApprovalFlowItem> afiList) {
        ...
        tvAccompanyPNuber.setText(bb.getEscorter());
        tvAccompanyPs.setText(bb.getEscortSum());
