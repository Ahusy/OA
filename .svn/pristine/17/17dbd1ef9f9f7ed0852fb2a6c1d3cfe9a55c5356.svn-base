...
public class MyAddressView extends RelativeLayout implements View.OnClickListener {
...
//    private int mSelectDistrictPosition = 0;//选中 区县  位置
    ...
    public MyAddressView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MyAddressView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        ...
        // UI
        View rootView = inflate(mContext, com.ywp.addresspickerlib.R.layout.address_picker_view, this);
        // 确定
        mTvSure = rootView.findViewById(com.ywp.addresspickerlib.R.id.tvSure);
        mTvSure.setTextColor(defaultSureUnClickColor);
        mTvSure.setOnClickListener(this);
        // tablayout初始化
        mTabLayout = (TabLayout) rootView.findViewById(com.ywp.addresspickerlib.R.id.tlTabLayout);
...
//        mTabLayout.addTab(mTabLayout.newTab().setText(defaultDistrict));
        ...
        mRvList = (RecyclerView) rootView.findViewById(com.ywp.addresspickerlib.R.id.rvList);
...
//            mSelectDistrict = null;
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.ywp.addresspickerlib.R.id.tvSure) {
            sure();
        }
    }
    ...
    private void sure() {
        if (mSelectProvice != null &&
            ...
            if (mOnAddressPickerSureListener != null) {
                mOnAddressPickerSureListener.onSureClick(mSelectProvice.getN() + " " + mSelectCity.getN() , mSelectProvice.getI(), mSelectCity.getI());
            }
        } else {
...
//                    mRvList.smoothScrollToPosition(mSelectDistrictPosition);
    ...
    class AddressAdapter extends RecyclerView.Adapter<AddressAdapter.ViewHolder> {
        ...
        public AddressAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new AddressAdapter.ViewHolder(LayoutInflater.from(mContext).inflate(com.ywp.addresspickerlib.R.layout.item_address_text, parent, false));
        }
...
//                            mSelectDistrictPosition = position;
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View itemView) {
                super(itemView);
                mTitle = (TextView) itemView.findViewById(com.ywp.addresspickerlib.R.id.itemTvTitle);
            }
