...
public class TourismActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    @ViewInject(R.id.tourism_one)
    private TextView roundOne;
    @ViewInject(R.id.tourism_two)
    private TextView roundTwo;
    @ViewInject(R.id.tourism_three)
    private TextView roundThree;
    ...
    protected void parseData(int requestCode, String data) {
        ...
        switch (requestCode) {
            case REQUEST_NET_ONE:
                ...
                roundOne.setBackgroundResource(R.drawable.shape_round_k);
                roundOne.setTextColor(getResources().getColor(R.color.title_color));
                roundTwo.setBackgroundResource(R.drawable.shape_round_s);
                roundTwo.setTextColor(getResources().getColor(R.color.white));
...
//                viewTwo.setVisibility(View.VISIBLE);
            ...
            case REQUEST_NET_TWO:
                roundOne.setBackgroundResource(R.drawable.shape_round_k);
                roundOne.setTextColor(getResources().getColor(R.color.title_color));
                roundTwo.setBackgroundResource(R.drawable.shape_round_k);
                roundTwo.setTextColor(getResources().getColor(R.color.title_color));
                roundThree.setBackgroundResource(R.drawable.shape_round_s);
                roundThree.setTextColor(getResources().getColor(R.color.white));
//                viewOne.setVisibility(View.GONE);
...
//                viewThree.setVisibility(View.VISIBLE);
            ...
            case REQUEST_NET_THREE:
                ...
                if (result.getResultCode().equals(REQUEST_NET_SUCCESS)) {
                    ...
                    finish();
                    SafeSharePreferenceUtil.clearDataByKey(this,"start_time");
                    SafeSharePreferenceUtil.clearDataByKey(this,"end_time");
                } else {
                    ToastUtil.show(this, result.getResultMsg());
                }
                break;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tourism_btn_return:
                current--;
                if (current == 1) {
                    roundOne.setBackgroundResource(R.drawable.shape_round_s);
                    roundOne.setTextColor(getResources().getColor(R.color.white));
                    roundTwo.setBackgroundResource(R.drawable.shape_round_k);
                    roundTwo.setTextColor(getResources().getColor(R.color.title_color));
                    roundThree.setBackgroundResource(R.drawable.shape_round_k);
                    roundThree.setTextColor(getResources().getColor(R.color.title_color));
//                    viewOne.setVisibility(View.VISIBLE);
//                    viewTwo.setVisibility(View.GONE);
