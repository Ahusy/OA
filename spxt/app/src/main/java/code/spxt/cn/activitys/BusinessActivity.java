...
public class BusinessActivity extends ToolBarActivity implements View.OnClickListener {
    ...
    public static void startAct(Activity activity, BillBusinessDetail ba, int requestCode) {
    ...
    private void initView() {
        ...
        BillBusinessDetail ab = getIntent().getParcelableExtra(EXTRA_OBJECT);
        if (ab != null) {
            unit.setText(ab.getVisitUnit());
            reason.setText(ab.getVisitReason());
            eatAddress.setText(ab.getEatPlace());
            accomAddress.setText(ab.getSleepPlace());
            personNum.setText(ab.getVisitSum());
            personName.setText(ab.getVisiter());
            companyNum.setText(ab.getEscortSum());
            companyPerson.setText(ab.getEscorter());
