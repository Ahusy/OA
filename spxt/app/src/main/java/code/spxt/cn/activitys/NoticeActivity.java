                ...
                if (noticeList != null){
                    ...
                    if (listBeans != null && listBeans.size() > 0){
                        ...
                        adapter.setOnItemClickListener((adapter1, view, position) -> {
                            NoticeDetailActivity.startNoticeDetail(this,listBeans.get(position).getName(),listBeans.get(position).getContent(),String.valueOf(listBeans.get(position).getCreateDate()));
                        });
                    }else{
